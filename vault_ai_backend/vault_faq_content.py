...
FAQ_ENTRIES: tuple[dict[str, Any], ...] = (
    ...
    _entry("how-local-signing-works", FAQ_CATEGORY_CRYPTO,
           "How does local signing work?",
           "Transaction details are prepared for review and signed with protected key material on your authorized device only after your explicit approval. Private signing keys are not sent to the backend or AI provider."),
    _entry("never-share-seed", FAQ_CATEGORY_SAFETY,
           "Why should I never share a seed phrase?",
           "A seed phrase can control the associated wallet. Anyone who obtains it may move the funds, so never enter it into chat or share it with SVaultAI staff, support, or an AI provider."),
