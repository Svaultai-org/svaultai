  ...
  group('storage-key persistence contract', () {
    test(
      ...
      () {
        ...
        const allowList = {
          'lib/device_id.dart',
          // Purges a stale iOS Keychain identity after reinstall.
        ...
        for (final ent in libDir.listSync(recursive: true)) {
          ...
          final relative =
              ent.path.replaceAll('\\', '/').replaceAll(RegExp(r'^\./'), '');
        ...
        expect(
          offenders,
          isEmpty,
          reason: 'These files reference the device-id storage key outside '
